...
#添加插件
mkdir -p package/feeds/small8
git clone https://github.com/kenzok8/small-package.git kenzok8
cp -rf kenzok8/luci-app-openclash package/feeds/small8/luci-app-openclash              # openclash
cp -rf kenzok8/luci-app-adguardhome package/feeds/small8/luci-app-adguardhome          # adguardhome
cp -rf kenzok8/adguardhome package/feeds/small8/adguardhome                            # adguardhome
cp -rf kenzok8/luci-app-mosdns package/feeds/small8/luci-app-mosdns                    # mosdns
cp -rf kenzok8/mosdns package/feeds/small8/mosdns                                      # mosdns
cp -rf kenzok8/v2dat package/feeds/small8/v2dat                                        # mosdns
rm -rf kenzok8
