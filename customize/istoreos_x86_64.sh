...
git clone --depth=1 https://github.com/sbwml/luci-app-mosdns mosdns
mv mosdns/mosdns feeds/small8/mosdns
mv mosdns/v2dat feeds/small8/v2dat
mv mosdns/luci-app-ddns-go feeds/small8/luci-app-ddns-go
rm -rf mosdns
